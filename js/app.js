          ...
          const mapboxToken = window.MAPBOX_TOKEN || 'PROVIDE_MAPBOX_TOKEN';
          const warningMessage = window.WARNING_MESSAGE || 'Please Provide a Mapbox Token in order to use Kepler.gl. Edit this repository secret MAPBOX_TOKEN with your access key';
          ...
          }(React, KeplerGl, window.MAPBOX_TOKEN || 'PROVIDE_MAPBOX_TOKEN'));
